...
CALL :fat16_cluster_to_lba      # LBA on stack (2 words)
CALL :heap_pop_D                # low word of LBA
CALL :heap_pop_C                # high word of LBA
...
.helpstr "Usage: cluster2lba <fs handle addr> <cluster number>\n\0"
.bad_addr_str "Error: %s is not a valid 16-bit word. strtoi flags: 0x%x\n\0"
.resultstr "LBA 0x%x%x%x%x\n\0"
